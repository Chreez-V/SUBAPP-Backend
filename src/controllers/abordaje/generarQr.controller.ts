...
export async function generarQrController(
  ...
  try {
    ...
    // Subimos a 24h minutos para que no te presione el tiempo en las pruebas
    const qrToken = jwt.sign(tokenPayload, secret, { expiresIn: "24h" });
